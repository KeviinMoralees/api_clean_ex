defmodule ApiClean.Application do
  @moduledoc """
  ApiClean application
  """

  alias ApiClean.Infrastructure.EntryPoint.ApiRest
  alias ApiClean.Config.{AppConfig, ConfigHolder}
  ...
  def start(_type, [env]) do
    ...
    opts = [strategy: :one_for_one, name: ApiClean.Supervisor]
  ...
  def env_children(_other_env, _config) do
    [
      {ApiClean.Infrastructure.Adapters.Repository.Repo, []}
    ]
  end
end
